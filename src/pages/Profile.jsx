    ...
    return (
        <div className="main">
            ...
            <div className={'profile-blocks'}>
                {settingsMode && userdate !== null &&
                    <ProfileSettings userdate={userdate}/>}
                {!settingsMode && <ProfileInfo userdate={userdate}/>}
